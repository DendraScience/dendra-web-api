...
class Service {
  ...
  async find(params) {
    ...
    const censorCodeQuery = query.censor_code !== undefined ? query.censor_code + '' : '';
    const qualityControlLevelCodeQuery = query.quality_control_level_code !== undefined ? query.quality_control_level_code + '' : '';
    ...
    while (isFetching) {
      ...
      saxStream.on('closetag', function (name) {
        if (name === 'value' && value && !isNaN(value.value) && (censorCodeQuery === '' || censorCodeQuery === value.censorCode) && (qualityControlLevelCodeQuery === '' || qualityControlLevelCodeQuery === value.qualityControlLevelCode)) {
          const {
            dateTime
          } = value;
