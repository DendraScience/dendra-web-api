...
class Service {
  ...
  async find(params) {
    ...
    if (!ids) throw new errors.GeneralError('Dendra datapoints requries query.datastream_ids.');
    ...
    await Promise.all(ids.map((id, index) => datapointsService.find({
      query: Object.assign({
        datastream_id: id
      }, datapointsQuery),
...
module.exports = function (app) {
  app.use('/dendra/datapoints', new Service()); // Get the wrapped service object, bind hooks
