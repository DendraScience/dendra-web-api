...
const dataFile = 'monterey-county.place'
  ...
  describe('#patch()', function () {
    ...
    it('sys admin should patch without error', function () {
      return helper
        ...
        .then(({ retDoc }) => {
          expect(retDoc).to.have.property('name', 'Monterey County - Patched')
        })
    })
  })
  ...
  describe('#update()', function () {
    ...
    it('sys admin should update without error', function () {
      return helper
        ...
        .then(({ retDoc }) => {
          expect(retDoc).to.have.property('name', 'Monterey County - Updated')
        })
    })
  })
